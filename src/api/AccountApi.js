...
export default
{
    ...
    ,useSearchChart : ( { queryOptions = { keys : ['', { pathString : null, queryString : null, params : null }], success : () => {}, settle : () => {}, isEnabled : true } } ) =>
    {
        const { GLOBAL_MODAL, GLOBAL_TOKEN } = useContext(GlobalContext);
        ...
        return queryUtil.useSingleQuery(
        {
            ...
            ,fn : params =>
            {
                ...
                { 
                     method : axiosUtil.METHOD.GET
                    ,url : '/account-service' + pathString + '/chart' + queryString
                    ,params : axiosParams
                    ,option : 
                    { 
                        headers: 
    ...
    ,useSearchAccountDetail : ( { queryOptions = { keys : ['', { pathString : null, queryString : null, params : null }], success : () => {}, settle : () => {}, isEnabled : true } } ) =>
    {
        const { GLOBAL_MODAL, GLOBAL_TOKEN } = useContext(GlobalContext);
    ...
    ,useUpdateAccount : ( { queryOptions = { pathString : null, success : () => {}, settle : () => {} } } ) =>
    {
        const { GLOBAL_MODAL, GLOBAL_TOKEN } = useContext(GlobalContext);
    ...
    ,useDeleteAccount : ( { queryOptions = { pathString : null, success : () => {}, settle : () => {} } } ) =>
    {
        const { GLOBAL_MODAL, GLOBAL_TOKEN } = useContext(GlobalContext);
